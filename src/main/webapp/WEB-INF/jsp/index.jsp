...
<h2 style="text-align: center;font-family: 'Adobe 楷体 Std R';color: palevioletred">吉 首 大 学 图 书 馆</h2>
...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        ...
        <div class="item">
            <img src="img/priscilla-du-preez-293218-unsplash.jpg" alt="第二张">
        </div>
        <div class="item">
            <img src="img/library.jpg" alt="第三张">
        </div>
